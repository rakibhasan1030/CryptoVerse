...
import rakib.hasan.cryptoverse.domain.use_case.get_coin.GetCoinUseCase
import rakib.hasan.cryptoverse.domain.use_case.get_coins.GetCoinsUseCase
...
class CoinDetailViewModel @Inject constructor(
    ...
    private fun getCoin(coinId: String){
        coinUseCase(coinId = coinId).onEach { result ->
            when(result){
                is Resource.Success ->{
